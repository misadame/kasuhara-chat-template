...
export default function Chat() {
  ...
  // ✅ ゴール設定（5回目〜10回目）
  const goalTips = [
    "クレーマーが納得するような、落としどころを見つけましょう。",
    "納得を引き出すには、相手の感情をまず受け止めることが重要です。",
    "「できない」ではなく「〜ならできます」という言い換えも有効です。",
    "相手が感情的な場合は、沈黙や間を活かすのも一つの手です。",
    "ここまでのやりとりを要約し、解決策を一文で提示してみましょう。"
  ];
    ...
    <div style={{ background: "#fff", color: "#000", padding: 20 }}>
      ...
      {userMessageCount >= 1 && (
        ...
        >
          ...
          {userMessageCount >= 5
            ? `ゴールのヒント：${
                goalTips[(userMessageCount - 5) % goalTips.length]
              }`
